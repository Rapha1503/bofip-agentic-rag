...
def build_system_prompt() -> str:
    return (
        ...
        "- partial ne doit pas etre utilise: si une reponse principale est possible, "
        "utilise supported et mets les reserves dans limits; sinon utilise insufficient_evidence.\n"
